...
# uPerlin
Easy integer implementation of Perlin noise. Base taken from FastLED and slightly improved
...
## Installation
- The library can be found under the name **uPerlin** and installed through the library manager in:
    - Arduino IDE
    - Arduino IDE v2
    - PlatformIO
- [Download the library](https://github.com/GyverLibs/uPerlin/archive/refs/heads/main.zip).zip archive for manual installation:
